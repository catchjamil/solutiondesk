...
<html>
	<head>
		...
		<title>Spring MVC Form Quotation</title>
					...
					<td>
						<div class="control-group">
							<label class="control-label" for="selectbasic">Unit</label>
								...
								<c:forEach items="${generateQuotationBean.listUnits}"  var="listUnits" varStatus="stat">
   								<OPTION value="${listUnits.shortName}">${listUnits.shortName}</OPTION>
								</c:forEach>
            				</select>
						</div>
					</td>
					...
					<td>
						...
						<div class="control-group">
							<label class="control-label" for="qnocode">Quotation No</label>
								<input id="qnocode" name="qnocode" type="text" value="Q" placeholder=""	class="input-mini"> 
								<input id="qnumber" name="qnumber"	type="text" value="${generateQuotationBean.quotationNo}" placeholder="" class="input-small">
							</div>
					</td>
					...
					<td>
						...
						<div class="control-group">
							<label class="control-label" for="qtype">Quotation Type</label>
									...
									<select id="selectbasic" name="selectbasic" class="input-large">
								<c:forEach items="${generateQuotationBean.quotationType}"  var="quotationType" varStatus="stat">
   								<OPTION value="${quotationType}">${quotationType}</OPTION>
								</c:forEach>
            				</select>
